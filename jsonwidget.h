...
private:
    ...
    static inline QString bracesForChildren(int number) { return QString("{%0}").arg(number); }
    static inline QString bracketsForChildren(int number) { return QString("[%0]").arg(number); }
